export default function Features() {
  const features = [
    { icon: '🗺️', title: 'Live Heatmap',  desc: 'Danger zones in real-time',  bg: '#1a0d0d' },
    { icon: '🤖', title: 'AI Chatbot',     desc: 'Ask safety questions',        bg: '#0d1a0d' },
    { icon: '🛡️', title: 'Safety Score',  desc: 'AI-predicted per locality',   bg: '#1a0d0d' },
    { icon: '👥', title: 'Community',      desc: 'Anonymous reporting',         bg: '#0d1a0d' },
  ]
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1px', background: '#1a1a1a', borderTop: '1px solid #1a1a1a' }}>
      {features.map(function(f, i) {
        return (
          <div key={i} style={{ background: '#0b0b0b', padding: '20px 18px' }}>
